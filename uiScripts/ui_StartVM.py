...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.comboBox_hook, 12, 1, 1, 2)

        self.label_hook = QLabel(self.gridLayoutWidget)
        self.label_hook.setObjectName(u"label_hook")

        self.gridLayout.addWidget(self.label_hook, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_7, 17, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.pushButton_4, 18, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_5, 19, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.pushButton_3, 18, 1, 1, 1)
        ...
        self.checkBox_debug_2 = QCheckBox(self.gridLayoutWidget)
        self.checkBox_debug_2.setObjectName(u"checkBox_debug_2")

        self.gridLayout.addWidget(self.checkBox_debug_2, 10, 1, 1, 1)

        self.checkBox_debug = QCheckBox(self.gridLayoutWidget)
        self.checkBox_debug.setObjectName(u"checkBox_debug")

        self.gridLayout.addWidget(self.checkBox_debug, 9, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_debug_2.setText(QCoreApplication.translate("Dialog", u"\u5173\u95edGUI", None))
